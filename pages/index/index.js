...
Page({
  data: {
    specification: '选择区域后，点击数字及运算符；\n输入计算表达式。将给出的牌数用尽并得出24即为一局完成。',
    userInfo: null,//{ avatarUrl:"../../images/avatar_default.png"},
    gradeArr: [{ name: '计时区', value: '../../images/button_tiaozhan.png' }, { name: '练习区', value: '../../images/button_wujin.png' }, { name: '排行榜', value: '../../images/button_rank.png'  }],
    grade: '计时区',
    roomId: 1,
  },
  //获取登录
 ...
 */
  ...
  gotoCount: function (e) {
    ...
    switch (dataId) {
      ...
      case '练习区'://练习区
        wx.navigateTo({ url: '../p_count/count?grade=' + dataId + '&room_id=' + me.data.roomId + '&user=' + JSON.stringify(me.data.userInfo) });
         break;
